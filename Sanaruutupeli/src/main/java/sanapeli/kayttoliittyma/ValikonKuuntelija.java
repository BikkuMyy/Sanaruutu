...
/**
 * Tapahtumienkuuntelija aloitusvalikolle, mahdollistaa ruudukon koon valinnan
 * ja pelin aloittamisen.
 *
 */
public class ValikonKuuntelija implements ActionListener {
     ...
     */
    public ValikonKuuntelija(JButton aloita, Kayttoliittyma kayttis) {
